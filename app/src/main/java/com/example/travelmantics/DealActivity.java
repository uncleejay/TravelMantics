...
public class DealActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabaseReference = FirebaseUtil.mDatabaseReferece;
        txtTitle = findViewById(R.id.txtTitle);
        txtDeescription = findViewById(R.id.txtDescription);
        ...
        txtDeescription.setText(deal.getDescription());
    ...
    private void saveDeal(){
        ...
        deal.setDescription(txtDeescription.getText().toString());
    ...
    private void clean() {
        txtTitle.setText("");
        txtPrice.setText("");
        txtDeescription.setText("");
        txtTitle.requestFocus();
    }

    private void enableEditTexts(boolean isEnabled) {
        txtTitle.setEnabled(isEnabled);
        txtDeescription.setEnabled(isEnabled);
